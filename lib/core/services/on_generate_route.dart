...
class RouteGenerator {
  ...
  static Route<dynamic> onGenerateRouteChatTab(RouteSettings settings) {
    switch (settings.name) {
      case RoutePath.chat:
        return _buildPageRoute((_) => const ChatView(), settings: settings);
      default:
        return _buildPageRoute(
          (_) => const Center(child: Text('No route found.')),
          settings: settings,
        );
    }
  }

  static Route<dynamic> onGenerateRouteProfileTab(RouteSettings settings) {
    switch (settings.name) {
      case RoutePath.profile:
        return _buildPageRoute((_) => const ProfileView(), settings: settings);
      ...
      case RoutePath.notification:
        return _buildPageRoute(
          (_) => const Center(child: Text('Notification View')),
          settings: settings,
        );
